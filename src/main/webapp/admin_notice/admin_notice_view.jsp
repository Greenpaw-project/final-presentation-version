...
<body>
	...
	<main>
      ...
      <div class="go-link">
        <ul class="link-menu">
          <li><a href="./admin_noticeboard.jsp?category=${param.category }&page=${param.page}">-List</a></li>
          <li><a href="./admin_notice_modify.jsp?category=${param.category }&page=${param.page}&seq=${param.seq }">-Modify</a></li>
