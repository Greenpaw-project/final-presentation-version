...
int flag = 1; //비로그인 상태
	...
	session.setAttribute("contentOwner", to.getNickname());
    ...
    <div class="main">
 	 ...
 	 <%@ include file="../nav_bar.jsp" %>
        ...
        <div class="album_right">
          <ul class="menu">
            <li class="menu_list">
              <a href="./community_album_modify.jsp?type=<%=type%>&cpage=<%=cpage%>&seq=<%=seq %>" id="edit">edit</a>
            </li>
            <li class="menu_list">
              <a href="#" id="delete">delete</a>
            </li>
            <li class="list">
              <a href="./community_album_list.jsp?type=<%=type%>&cpage=<%=cpage%>">list</a>
            </li>
            <li class="new">
              <a href="./community_album_write.jsp">new</a>
            </li>
          </ul>
        </div>
      </div>
