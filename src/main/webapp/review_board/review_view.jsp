 	 ...
 	 <%@ include file="../nav_bar.jsp" %>
        ...
        <div class="album_right">
          ...
          <%if(nickname != null && nickname.equals(sessionNickname)){%>
            <li class="menu_list">
              <a href="./review_modify.jsp?cpage=<%=cpage%>&seq=<%=seq %>&type=<%=familyMemberType%>" id="edit">edit</a>
            </li>
            <li class="menu_list">
            ...
            <% }%>
            <li class="list">
              <a href="./Review_board.jsp?categorySeq=<%=categorySeq%>&type=<%=familyMemberType%>&cpage=<%=cpage%>">list</a>
            </li>
          </ul>
        </div>
      </div>
