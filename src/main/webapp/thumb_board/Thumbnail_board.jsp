...
<%
	...
	for( BoardTO to : boardLists ) {
		...
		sbHtml.append("			</div>");
		sbHtml.append("				<div class='thumb'><a href='./thumb_view.jsp?cpage="+cpage+"&seq="+seq+"&type="+familyMemberType+"'>");
		...
		sbHtml.append("				</div>");
		sbHtml.append("				<div class='list-title'><a href='./thumb_view.jsp?cpage="+cpage+"&seq="+seq+"&type="+familyMemberType+"'>");
  ...
  <body>
    ...
    <div class="main-body">
        ...
        <div class="main-body-banner">
            <div class="banner" style="cursor:pointer;" onclick="location.href='./Thumbnail_board.jsp?categorySeq=${param.categorySeq}'"></div>
        </div>
        <!-- 검색창 -->
        <div class="search_wrap">
            <form action="./Thumbnail_board.jsp" method="get" class="searchform">
        ...
        <div class="inner_content">
                <div class="filter_wrap">
               		<div>
                		<a class="search_filter" href="./Thumbnail_board.jsp?categorySeq=${param.categorySeq}&field=${param.field}&keyword=${param.keyword}&sort=seq">최근 순</a>

                		<a class="search_filter" href="./Thumbnail_board.jsp?categorySeq=${param.categorySeq}&field=${param.field}&keyword=${param.keyword}&sort=hit">조회 순</a>
                		
                		<a class="search_filter" href="./Thumbnail_board.jsp?categorySeq=${param.categorySeq}&field=type&keyword=pet">동물</a>
						
						<a class="search_filter" href="./Thumbnail_board.jsp?categorySeq=${param.categorySeq}&field=type&keyword=plant">식물</a>
                	</div>
                </div>
                <div class="list_wrap">
                    <!------ 리스트 -------->
                    ...
                    <a type="button" href="./thumb_write.jsp?categorySeq=<%=categorySeq %>" id="write-btn">글쓰기</a>
                <!--페이지-->
